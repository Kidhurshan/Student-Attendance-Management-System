    ...
    <div class="card-body">
      <?php
          if (isset($_GET["RegNo"])) {
              ...
              if (!$row) {
                  die("No data found for RegNo: $RegNo");
              }
      ?>
              <header class="d-flex justify-content-between my-3">
              <h1><i class="bi bi-pencil-square"></i> Edit Student detail</h1>
              <div>
              ...
              <form action="process.php" method ="POST">
                  ...
                  <div class ="input-group input-group-md mb-3">
                      <span class="input-group-text">RegNo:</span>
                  ...
                  <div class ="input-group input-group-md mb-3">
                      ...
                      <input type ="text" name="Batch"  value="<?php echo $row["Batch"];?>"  class="form-control" >
                  </div>
              <div class="input-group input-group-md mb-3">
                  <span class="input-group-text">MA Approval:</span>
                  <select name="MA-Approval" required class="form-select form-select-sm">
                          <option value="">Approval</option>
                          <option value="Active" <?= isset($row['MA-Approval']) && $row['MA-Approval'] == 'Active' ? 'selected' : '' ?>>Active</option>
                          <option value="Pending" <?= isset($row['MA-Approval']) && $row['MA-Approval'] == 'Pending' ? 'selected' : '' ?>>Pending</option>
                          <option value="Not" <?= isset($row['MA-Approval']) && $row['MA-Approval'] == 'Not' ? 'selected' : '' ?>>Not</option>
                  </select>
              </div>
