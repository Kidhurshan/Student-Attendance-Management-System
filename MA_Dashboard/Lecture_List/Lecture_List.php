    ...
    <div class="card head-card p-3 mt-2">
        <div class="card-body">
            ...
            <div class="container my-2">
                <h1 class="text-center"><i class="bi bi-bookmark-star"></i> Lecturer List</h1>
            <br>
                <div class="card">
                    <div class="card-header">
                        <div class="row">  
                            <div class="col-md-3">
                                <a href="create.php" class ="btn btn-primary"> <i class="bi bi-person-plus"></i> Add Lecturer</a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <?php
                            ...
                            while ($row = mysqli_fetch_array($result)) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="edit.php?id=<?php echo $row["Lecture-ID"];?>" class= "btn btn-primary"><i class="bi bi-pencil"></i> edit</a>
                                        <a href="delete.php?id=<?php echo $row["Lecture-ID"];?>" class= "btn btn-danger"><i class="bi bi-trash"></i> delete</a>
                                    </td>
                                </tr>
                                <?php
                            }
