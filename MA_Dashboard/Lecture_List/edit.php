...
<head>
  ...
  <title>Edit Lecturer detail</title>
  <!-- Bootstrap CSS -->
      ...
      <div class="card head-card p-3 mt-2">
        <div class="card-body">
          ...
          if(isset($_GET["id"])){
              $id = $_GET["id"];
              include("../connect.php") ;
              $sql="SELECT * FROM lecturer WHERE `Lecture-ID` ='$id'";
              $result = mysqli_query($conn,$sql);
              $row = mysqli_fetch_array($result);
            ?>
              <header class="d-flex justify-content-between my-3">
              <h1><i class="bi bi-bookmarks"></i> Edit Lecturer</h1>
              <div>
              ...
              <div class="row">   
                ...
                <div class="col-md-8">
                  ...
                  <div class="input-group input-group-md mb-3">
                      ...
                      <input type="text" class="form-control" placeholder="Mid Name" name="MidName"  value="<?php echo $row["MidName"];?>">
                  </div>
                  <div class="input-group input-group-md mb-3">
                  ...
                  <div class ="input-group input-group-md mb-3">
                      ...
                      <input type ="text" name="Profession"  value="<?php echo $row["Profession"];?>"  class="form-control">
                  </div>
                  <div class ="input-group input-group-md mb-3">
                  ...
                  <div class ="input-group input-group-md mb-3">
                      <span class="input-group-text">Lecturer ID:</span>
                      <input type ="text" name="Lecture-ID"  value="<?php echo $row["Lecture-ID"];?>"  class="form-control" readonly>
                  </div>
