...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($new_password != $repeat_password) {
        ...
        header("Location: ../MA_index.php");
        exit();
    }

    // Validate old password and email from the database
    $query = "SELECT * FROM ma WHERE Email = ?";
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($old_password, $hashed_password)) {
            ...
            $update_query = "UPDATE ma SET Password = ? WHERE Email = ?";
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav ms-auto">
          ...
          <li class="nav-item">
            <a class="nav-link active" href="../Password_Reset/Password_Reset.php">Reset Password</a>
          </li>
          <li class="nav-item">
...
<div class="content">
  <div class="card head-card p-3 mt-2">
    <div class="card-body">
            <h1 class = "text-white text-center"><i class="bi bi-file-earmark-lock2"></i> Reset Password</h1>
              ...
              <div class="col-md-8">
                <form action="Password_Reset.php" method="POST">
                    <div class="mb-3 mt-3 input-group input-group-md">
                        <span class="input-group-text" id="email-label"><i class="bi bi-envelope"></i> Email</span>
                    ...
                    <button type="submit" class="btn btn-success btn-md mt-2"><i class="bi bi-arrow-repeat"></i> Reset Password</button>
                </form>
              </div>
          </div>
      </div>
