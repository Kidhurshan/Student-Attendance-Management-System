      ...
      if(isset($_GET["Batch"])){
          ...
          <div class="container my-5">
              <header class="d-flex justify-content-between my-3">
                  <h1><i class="bi bi-person-lines-fill"></i> Student List</h1>
                  <div>
                      <a href="Course_Allocation.php" class="btn btn-danger">Back</a>
                  </div>
              </header>
              <br>
              <div class="row">   
                  ...
                  <table class="table table-bordered my-3 table-hover text-center">
                      ...
                      <tbody>
                          ...
                          if (mysqli_num_rows($result) > 0) {
                              ...
                              echo "<tr><td colspan='2'>No records found</td></tr>"; // Provide feedback to the user
                          }
                          ?>
                      </tbody>
                  </table>
