...
<div class="content"> 
    <div class="card head-card p-3 mt-2">
        <div class="card-body">
                ...
                ?>
                <div class="container">
                        <h1 class="text-center mb-3"><i class="bi bi-list-ul"></i> Course Allocation</h1>
                    <div class="card">
                                    ...
                                    <form action="" method="GET">
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <a href="Course_Allocation.php" class="btn btn-danger"><i class="bi bi-x-octagon"></i> Reset</a>
                                            </div>
                                            <div class="col-md-4">
                                                <a href="create.php" class ="btn btn-primary"><i class="bi bi-cloud-plus"></i> Add Course Allocation</a>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                    ...
                    <table class="table table-bordered my-3 table-hover text-center">
                        ...
                        ?>
                            <tr>                          
                                ...
                                <td>
                                    <a href="view-students.php?Batch=<?php echo $row["Batch"];?>" class="btn btn-outline-dark"><?php echo $row['Batch'];?></a>
                                </td>
                                <td>
                                    <a href="edit.php?AllocationID=<?php echo $row["AllocationID"];?>" class="btn btn-primary"><i class="bi bi-pencil"></i> edit</a>
                                    <a href="delete.php?AllocationID=<?php echo $row["AllocationID"];?>" class="btn btn-danger"><i class="bi bi-trash"></i> delete</a>
                                </td>                     
                            </tr>
                        <?php
                        }
