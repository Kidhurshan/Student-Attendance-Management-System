  ...
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="content">
        <div class="card head-card p-3 mt-2">
            <div class="card-body">
                <h1 class="text-white text-center mb-3"><i class="bi bi-list-ul"></i> Course List</h1>
                <br>
                <div class="card">
                    ...
                    <tbody>
                        <?php
                            ...
                            if (isset($_GET['AcademicYear']) && $_GET['AcademicYear'] != '' && isset($_GET['Semester']) && $_GET['Semester'] != '') {
                                ...
                                $sql = "SELECT c.CourseCode, c.CourseName, c.Credit, c.LecHour 
                                        FROM Course c 
                                        JOIN CourseAllocation ca ON c.CourseCode = ca.CourseCode 
                                        WHERE c.Semester = ? AND ca.AcademicYear = ?";
