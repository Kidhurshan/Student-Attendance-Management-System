...
<?php
    ...
    if(isset($_GET["AllocationID"])){
        ...
        echo "AllocationID not provided in the URL.";
        exit();
    }
?>
  ...
  <div class="card head-card p-3 mt-2">
    <div class="card-body">
        <header class="d-flex justify-content-between my-3">
            <h1 class="mx-5"><i class="bi bi-plus-circle"></i> Create Time Schdule</h1>
            ...
            <div class="col-md-8">
                <form action="create_process.php" method ="post">
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input type="hidden" name="AllocationID" value="<?php echo $AllocationID;?>" class="form-control">
                        </div>
                        
                        <input type = "submit" class = "btn btn-primary my-3" name = "enter" value="Save">
                </form>
            </div>
        </div>
    </div>
