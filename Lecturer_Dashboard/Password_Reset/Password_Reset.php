...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        if (password_verify($old_password, $hashed_password)) {
            ...
            $update_query = "UPDATE lecturer SET Password = ? WHERE Email = ?";
...
<div class="content">
  <div class="card head-card p-3 mt-2">
    <div class="card-body">
            <h1 class="text-center text-white my-2">Reset Password</h1>
            <br>
        ...
        <div class="row">   
            ...
            <div class="col-md-8">
              ...
              <div class="mb-3 mt-3 input-group input-group-md">
                ...
                <button type="submit" class="btn btn-success btn-md my-2"><i class="bi bi-arrow-repeat"></i> Reset Password</button>
            </form>
            </div>
        </div>
      </div>
