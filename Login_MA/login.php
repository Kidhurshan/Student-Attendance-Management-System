...
<body>
    <div class="container p-5 my-20">
        ...
        if(isset($_POST["login"]) ){
            ...
            if($user){
                if(password_verify($password,$user["Password"])){
                    ...
                    header("Location: ../MA_Dashboard/MA_index.php");
                    die();
                }else{
                    ?>
                    <div class='alert alert-danger alert-dismissible fade show my-3 mx-3'>
                    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                    <strong>Info!</strong>Password does't match</div>
                    <?php ;
                }
            }else{
                ?>
                    <div class='alert alert-danger alert-dismissible fade show my-3 mx-3'>
                    <button type="button" class="btn-close" data-bs-dismiss="alert"></button>
                    <strong>Info!</strong>Email does't match</div>
                    <?php ;
            }
        ...
        <div class="row">   
                <div class="col-md-4">
                <img src="../icons/anim-b/management.gif" class="img-fluid rounded" alt="Image">
                </div>
        <div class="col-md-8">     
