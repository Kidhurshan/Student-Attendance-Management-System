...
<div class="content"> 
  <div class="card head-card glass-effect p-3">
    <div class="card-body">
      <div class="container text-center">
        <h1 class="text-white text-center my-2">Semester</h1>
        <br>
          <?php
          if(isset($_SESSION["Email"])) {
              ...
              if($result && mysqli_num_rows($result) > 0) {
                  ...
                  ?>
                  <a href="Attendance_select.php?Semester=<?= $row_semester['Semester'];?>" class="btn btn-danger btn-lg">Semester <?= $row_semester['Semester'];?></a>
                  <?php
                  }
              }
          }
  ...
  <div class="card head-card glass-effect p-3">
    <div class="card-body">
      <img src="../../icons/not-found/select-semester.png" class="img-take-attendance" alt="Image">
    </div>
  </div>
</div>
